...
#Fig1
```{r}
fig1 <- read.csv("../Rocio-Figures/Fig1.csv")
fig1 <- fig1 %>%
...
for (s in unique(summary_df$Species)) {
 ...
 theme(
  ...
  ggsave(
    filename = paste0("../Rocio-Figures/plots/fig1_total_", s, ".png"),
    plot = p,
    width = 6, height = 4, dpi = 300, limitsize = FALSE
  )
}
...
for (s in unique(summary_df$Species)) {
 ...
 theme(
  ...
  ggsave(
    filename = paste0("../Rocio-Figures/plots/fig1_individual_", s, ".png"),
    plot = p,
